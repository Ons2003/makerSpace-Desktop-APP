...
public class NewTimeEvent_Controller {
    ...
    public void SetupData(String dayName, boolean isEditing, TopicParameters topicParameters){
        ...
        eventType_cbox.setItems(FXCollections.observableArrayList(MakerspaceTimeline_Controller.GetTopicsTitlesForUserRole(AccountsManager.loggedAccount.role)));
    ...
    public void SaveEdits_ButtonInput() {
        ...
        MakerspaceTimeline_Controller.instance.SaveTimeEventEdits(name, new Instant(startHour, startMinute),
                new Instant(endHour, endMinute), (String)eventType_cbox.getValue(), descriptionTArea.getText());
    }

    public void DeleteEvent_ButtonInput() {
        MakerspaceTimeline_Controller.instance.RemoveTimeEvent();
    }
    ...
    public void CreateEvent_ButtonInput(){
        ...
        MakerspaceTimeline_Controller.instance.CreateNewTimeEvent(name, new Instant(startHour, startMinute),
                new Instant(endHour, endMinute), (String)eventType_cbox.getValue(), descriptionTArea.getText());
        MakerspaceTimeline_Controller.instance.FinishEventEditing();
    }
}
